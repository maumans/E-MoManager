...
import {
    ...
    Radio,
    Autocomplete,
    TextareaAutosize, InputAdornment, MenuItem, Select,
} from "@mui/material";
...
function Create({auth,errors,villes,typeBiens}) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        post(route("gestion.lot.store",[auth.user.id]),{preserveScroll:true})
    }
                ...
                <form onSubmit={handleSubmit} className={"space-y-10 w-full rounded mt-5"}>
                    ...
                    <div className={"bg-white p-5 grid md:grid-cols-2 gap-5"}>
                        ...
                        <div className={"md:col-span-2 emeFont font-bold appThemeColorInfo"}>
                            L'ajout des biens au lot n'est pas obligatoire vous pouvez le faire maintenant ou plus tard <span className={"text-red-500"}>*</span>
                        </div>
