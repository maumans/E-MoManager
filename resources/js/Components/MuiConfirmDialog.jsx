...
export function MuiConfirmDialogForm(props) {
    ...
    return (
        <>
            <button disabled={props.index!==0} type={"button"} onClick={handleClickOpen} className="disabled:text-gray-400 disabled:border-gray-400 disabled:bg-white border border-green-500 text-green-500 hover:bg-green-500 hover:text-white text-white py-2 px-4 rounded ml-auto transition duration-500" >
                {
                    props.buttonText
                }
            </button>
                ...
                <DialogActions>
                    ...
                    <button type={"button"} onClick={()=>
                    {
                        ...
                        props.handleAction()
                            ...
                            className={"p-2 text-white bg-green-700 rounded hover:text-green-700 hover:bg-white transition duration-500"}
                    >
                        Valider
                    </button>
                </DialogActions>
